        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                    <button class="tablink" onclick="openPage('login', this, '#ff8f5e', '#fff')" id="defaultOpen">تسجيل الدخول</button>
                    ...
                    <div id="login" class="tabcontent register-card">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url("login") }}">
                            {{ csrf_field() }}
                            <label>{{__('auth.UserName')}}</label>
                            <input id="username" type="text" name="username" class="form-control" placeholder="{{__('auth.UserName')}}" value="{{ old('username') }}" required autofocus>
                            @if ($errors->has('username'))
                                <span class="help-block">
                                            <strong>{{ $errors->first('username') }}</strong>
                                        </span>
                            ...
                            <input type="submit" class="btn btn-primary btn-block" value="{{__('auth.login')}}" />
                        </form>
                        {{--<div class="forgot">

                            <a href="{{ route('register') }}" class="btn btn-simple btn-danger">{{__('auth.dont have account')}}</a>
                        </div>--}}
                    </div>
                </div>
